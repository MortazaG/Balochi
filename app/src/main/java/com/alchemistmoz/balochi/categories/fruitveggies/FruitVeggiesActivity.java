...
public class FruitVeggiesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CustomToolbar toolbar = new CustomToolbar(FruitVeggiesActivity.this);
    ...
    private void initiateMenu() {
        ...
        categories.add(new Category(R.drawable.fruitveggies_menu_repetition2, R.raw.menu_repetition, RepetitionActivity.class));
        categories.add(new Category(R.drawable.fruitveggies_menu_memory, R.raw.menu_memory, MemoryActivity.class));
        categories.add(new Category(R.drawable.fruitveggies_menu_audiomatch4, R.raw.menu_repetition, AudioMatchActivity.class));
