...
public class ColorsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CustomToolbar toolbar = new CustomToolbar(ColorsActivity.this);
    ...
    private void initiateMenu() {
        ...
        categories.add(new Category(R.drawable.colors_menu_audiomatch3, R.raw.menu_colors, AudioMatchActivity.class));
